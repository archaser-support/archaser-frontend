...
import {
    getFinancialChartDetailsTitle,
} from "@/shared/dashboard/financialChartDetailsTitle";
...
export default function ChartDetailsPage({ params }: ChartDetailsProps) {
    ...
    const getChartTitle = (type: string) => {
        return getFinancialChartDetailsTitle(t, {
            type,
            period,
            daysRange,
    ...
    const pageTitle = getChartTitle(chartType);
