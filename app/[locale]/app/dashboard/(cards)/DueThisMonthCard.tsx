...
type DueThisMonthCardProps = {
    count?: number;
    currency?: string;
};

const DueThisMonthCard = ({
    count = 0,
    currency = "USD",
}: DueThisMonthCardProps) => {
    ...
    return (
        <CreditMetricCard
            ...
            label={t("fields.stats_due_this_month")}
            ...
            tooltip={t("tooltips.financial_metric_due_this_month")}
            onClick={handleCardClick}
        />
    );
};

export default DueThisMonthCard;
