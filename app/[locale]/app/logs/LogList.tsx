    ...
    return (
        <Fade in timeout={300}>
            <Box sx={{ width: "100%", maxWidth: "100%" }}>
                <PageHeader
                    title={t("sections.logs", { defaultValue: "Logs" })}
                    description={t("fields.logs_description", {
                        defaultValue:
                            "View all logs for your account including user logins, account changes, settings modifications, and all operations performed by any user in this account",
                    })}
                />
