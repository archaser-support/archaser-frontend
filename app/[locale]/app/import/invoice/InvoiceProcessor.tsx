...
const FIELD_MAPPING = {
    ...
    customer_amount_without_vat: "customer_amount_without_vat",
    customer_vat_amount: "customer_vat_amount",
...
const InvoiceProcessor: React.FC = () => {
    ...
    const exampleValues = {
        ...
        amount_without_vat: 1282.05,
        vat_amount: 217.95,
        customer_amount_without_vat: 1282.05,
        customer_vat_amount: 217.95,
