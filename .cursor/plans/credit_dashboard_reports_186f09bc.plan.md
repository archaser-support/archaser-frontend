...
todos:
  - id: filter-contract
    content: Add creditDashboardReportFilters + type→context/unique_name/additionalFilters
    status: pending
  - id: membership-expand
    content: Refactor get*Report membership; expand credit markers on report execute
    status: pending
  - id: seed-sql
    content: Seed dashboard_credit_customers + dashboard_credit_invoices system reports
    status: pending
  - id: view-configs
    content: Add viewConfigs + dashboard-context helpers for the two credit contexts
    status: pending
  - id: vbdg-lock-selector
    content: Add reportSelector prop; lock URL type on credit report page
    status: pending
  - id: replace-grid
    content: Replace CreditInsuranceReportGrid with ViewBased wrapper; keep chrome + mark actions
    status: pending
  - id: tests
    content: Unit tests for filter contract/membership; manual parity checklist for all 11 types
    status: pending
isProject: false
---
...
**Parent:** [Credit dashboard detail lists → ViewBased reports](https://app.clickup.com/t/869e6fue8)

| # | Title | ClickUp | Waiting on | User stories |
|---|-------|---------|------------|--------------|
| 1 | Overdue credit report → ViewBased (tracer) | [869e6fuek](https://app.clickup.com/t/869e6fuek) | — | First end-to-end ViewBased overdue list with locked selector |
| 2 | Customer KPI credit reports → ViewBased | [869e6fuem](https://app.clickup.com/t/869e6fuem) | #1 | capacity, policy_risk, limit_warning, zero_limit_warning, no_policy_exposure |
| 3 | Invoice credit reports + mark-reported actions | [869e6fuep](https://app.clickup.com/t/869e6fuep) | #1 | terms, reporting, reported + mark/bulk/export |
| 4 | Top-up credit reports → ViewBased | [869e6fuet](https://app.clickup.com/t/869e6fuet) | #1 | top_up, top_up_expiring |
| 5 | Credit report ViewBased cutover + cleanup | [869e6fueu](https://app.clickup.com/t/869e6fueu) | #2, #3, #4 | Remove EndlessScroll path; all 11 types on ViewBased |
